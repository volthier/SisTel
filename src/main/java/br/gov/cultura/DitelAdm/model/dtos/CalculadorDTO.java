...
public class CalculadorDTO {
	...
	public CalculadorDTO(int inteiroA, int inteiroB, int resultadoI, float floatA, float floatB, float valorTotalAtesto,
			float resultadoF, double doubleA, double doubleB, double resultadoD, Date dataA, Date dataB,
			Date resultadoDt, String stringA, String stringB, String resultadoS) {
		super();
		...
		this.floatA = floatA;
		this.floatB = floatB;
		this.valorTotalAtesto = valorTotalAtesto;
	...
	public float getValorTotalAtesto() {
		return valorTotalAtesto;
	}

	public void setValorTotalAtesto(float valorTotalAtesto) {
		this.valorTotalAtesto = valorTotalAtesto;
	}
