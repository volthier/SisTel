...
public class RetornoConsultaDocumento  implements java.io.Serializable {
    ...
    private br.gov.cultura.DitelAdm.wsdl.Serie serie;
    ...
    private br.gov.cultura.DitelAdm.wsdl.Unidade unidadeElaboradora;

    private br.gov.cultura.DitelAdm.wsdl.Andamento andamentoGeracao;

    private br.gov.cultura.DitelAdm.wsdl.Assinatura[] assinaturas;

    private br.gov.cultura.DitelAdm.wsdl.Publicacao publicacao;

    private br.gov.cultura.DitelAdm.wsdl.Campo[] campos;
    ...
    public RetornoConsultaDocumento(
           ...
           br.gov.cultura.DitelAdm.wsdl.Serie serie,
           java.lang.String numero,
           java.lang.String descricao,
           java.lang.String data,
           br.gov.cultura.DitelAdm.wsdl.Unidade unidadeElaboradora,
           br.gov.cultura.DitelAdm.wsdl.Andamento andamentoGeracao,
           br.gov.cultura.DitelAdm.wsdl.Assinatura[] assinaturas,
           br.gov.cultura.DitelAdm.wsdl.Publicacao publicacao,
           br.gov.cultura.DitelAdm.wsdl.Campo[] campos) {
     ...
     * @return serie
     */
    public br.gov.cultura.DitelAdm.wsdl.Serie getSerie() {
        return serie;
    }
     ...
     * @param serie
     */
    public void setSerie(br.gov.cultura.DitelAdm.wsdl.Serie serie) {
        this.serie = serie;
    }
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.Unidade getUnidadeElaboradora() {
        return unidadeElaboradora;
    }
     ...
     */
    public void setUnidadeElaboradora(br.gov.cultura.DitelAdm.wsdl.Unidade unidadeElaboradora) {
        this.unidadeElaboradora = unidadeElaboradora;
    }
     ...
     * @return assinaturas
     */
    public br.gov.cultura.DitelAdm.wsdl.Assinatura[] getAssinaturas() {
        return assinaturas;
    }
     ...
     * @param assinaturas
     */
    public void setAssinaturas(br.gov.cultura.DitelAdm.wsdl.Assinatura[] assinaturas) {
        this.assinaturas = assinaturas;
    }
     ...
     * @return publicacao
     */
    public br.gov.cultura.DitelAdm.wsdl.Publicacao getPublicacao() {
        return publicacao;
    }
     ...
     * @param publicacao
     */
    public void setPublicacao(br.gov.cultura.DitelAdm.wsdl.Publicacao publicacao) {
        this.publicacao = publicacao;
    }
     ...
     * @return campos
     */
    public br.gov.cultura.DitelAdm.wsdl.Campo[] getCampos() {
        return campos;
    }
     ...
     * @param campos
     */
    public void setCampos(br.gov.cultura.DitelAdm.wsdl.Campo[] campos) {
        this.campos = campos;
    }
