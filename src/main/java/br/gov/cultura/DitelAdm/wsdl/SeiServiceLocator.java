...
public class SeiServiceLocator extends org.apache.axis.client.Service implements br.gov.cultura.DitelAdm.wsdl.SeiService {
    ...
    private java.lang.String SeiPortService_address = "https://sei.cultura.gov.br/sei/ws/SeiWS.php";
    ...
    public br.gov.cultura.DitelAdm.wsdl.SeiPortType getSeiPortService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.gov.cultura.DitelAdm.wsdl.SeiBindingStub _stub = new br.gov.cultura.DitelAdm.wsdl.SeiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.gov.cultura.DitelAdm.wsdl.SeiPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.gov.cultura.DitelAdm.wsdl.SeiBindingStub _stub = new br.gov.cultura.DitelAdm.wsdl.SeiBindingStub(new java.net.URL(SeiPortService_address), this);
                _stub.setPortName(getSeiPortServiceWSDDServiceName());
                return _stub;
            }
        }
