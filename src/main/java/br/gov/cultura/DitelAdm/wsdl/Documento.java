...
public class Documento  implements java.io.Serializable {
    ...
    private br.gov.cultura.DitelAdm.wsdl.Remetente remetente;

    private br.gov.cultura.DitelAdm.wsdl.Interessado[] interessados;

    private br.gov.cultura.DitelAdm.wsdl.Destinatario[] destinatarios;
    ...
    public Documento(
           ...
           br.gov.cultura.DitelAdm.wsdl.Remetente remetente,
           br.gov.cultura.DitelAdm.wsdl.Interessado[] interessados,
           br.gov.cultura.DitelAdm.wsdl.Destinatario[] destinatarios,
     ...
     * @return remetente
     */
    public br.gov.cultura.DitelAdm.wsdl.Remetente getRemetente() {
        return remetente;
    }
     ...
     * @param remetente
     */
    public void setRemetente(br.gov.cultura.DitelAdm.wsdl.Remetente remetente) {
        this.remetente = remetente;
    }
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.Destinatario[] getDestinatarios() {
        return destinatarios;
    }
     ...
     * @param destinatarios
     */
    public void setDestinatarios(br.gov.cultura.DitelAdm.wsdl.Destinatario[] destinatarios) {
        this.destinatarios = destinatarios;
    }
