...
public class Publicacao  implements java.io.Serializable {
    ...
    private br.gov.cultura.DitelAdm.wsdl.PublicacaoImprensaNacional imprensaNacional;
    ...
    public Publicacao(
           ...
           br.gov.cultura.DitelAdm.wsdl.PublicacaoImprensaNacional imprensaNacional) {
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.PublicacaoImprensaNacional getImprensaNacional() {
        return imprensaNacional;
    }
     ...
     */
    public void setImprensaNacional(br.gov.cultura.DitelAdm.wsdl.PublicacaoImprensaNacional imprensaNacional) {
        this.imprensaNacional = imprensaNacional;
    }
