...
public class RetornoConsultaProcedimento  implements java.io.Serializable {
    ...
    private br.gov.cultura.DitelAdm.wsdl.TipoProcedimento tipoProcedimento;

    private br.gov.cultura.DitelAdm.wsdl.Andamento andamentoGeracao;

    private br.gov.cultura.DitelAdm.wsdl.Andamento andamentoConclusao;

    private br.gov.cultura.DitelAdm.wsdl.Andamento ultimoAndamento;

    private br.gov.cultura.DitelAdm.wsdl.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto;

    private br.gov.cultura.DitelAdm.wsdl.Assunto[] assuntos;

    private br.gov.cultura.DitelAdm.wsdl.Interessado[] interessados;

    private br.gov.cultura.DitelAdm.wsdl.Observacao[] observacoes;

    private br.gov.cultura.DitelAdm.wsdl.ProcedimentoResumido[] procedimentosRelacionados;

    private br.gov.cultura.DitelAdm.wsdl.ProcedimentoResumido[] procedimentosAnexados;
    ...
    public RetornoConsultaProcedimento(
           ...
           br.gov.cultura.DitelAdm.wsdl.TipoProcedimento tipoProcedimento,
           br.gov.cultura.DitelAdm.wsdl.Andamento andamentoGeracao,
           br.gov.cultura.DitelAdm.wsdl.Andamento andamentoConclusao,
           br.gov.cultura.DitelAdm.wsdl.Andamento ultimoAndamento,
           br.gov.cultura.DitelAdm.wsdl.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto,
           br.gov.cultura.DitelAdm.wsdl.Assunto[] assuntos,
           br.gov.cultura.DitelAdm.wsdl.Interessado[] interessados,
           br.gov.cultura.DitelAdm.wsdl.Observacao[] observacoes,
           br.gov.cultura.DitelAdm.wsdl.ProcedimentoResumido[] procedimentosRelacionados,
           br.gov.cultura.DitelAdm.wsdl.ProcedimentoResumido[] procedimentosAnexados) {
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.TipoProcedimento getTipoProcedimento() {
        return tipoProcedimento;
    }
     ...
     */
    public void setTipoProcedimento(br.gov.cultura.DitelAdm.wsdl.TipoProcedimento tipoProcedimento) {
        this.tipoProcedimento = tipoProcedimento;
    }
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.Andamento getAndamentoGeracao() {
        return andamentoGeracao;
    }
     ...
     */
    public void setAndamentoGeracao(br.gov.cultura.DitelAdm.wsdl.Andamento andamentoGeracao) {
        this.andamentoGeracao = andamentoGeracao;
    }
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.Andamento getAndamentoConclusao() {
        return andamentoConclusao;
    }
     ...
     */
    public void setAndamentoConclusao(br.gov.cultura.DitelAdm.wsdl.Andamento andamentoConclusao) {
        this.andamentoConclusao = andamentoConclusao;
    }
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.Andamento getUltimoAndamento() {
        return ultimoAndamento;
    }
     ...
     */
    public void setUltimoAndamento(br.gov.cultura.DitelAdm.wsdl.Andamento ultimoAndamento) {
        this.ultimoAndamento = ultimoAndamento;
    }
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.UnidadeProcedimentoAberto[] getUnidadesProcedimentoAberto() {
        return unidadesProcedimentoAberto;
    }
     ...
     */
    public void setUnidadesProcedimentoAberto(br.gov.cultura.DitelAdm.wsdl.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto) {
        this.unidadesProcedimentoAberto = unidadesProcedimentoAberto;
    }
     ...
     * @return assuntos
     */
    public br.gov.cultura.DitelAdm.wsdl.Assunto[] getAssuntos() {
        return assuntos;
    }
     ...
     * @param assuntos
     */
    public void setAssuntos(br.gov.cultura.DitelAdm.wsdl.Assunto[] assuntos) {
        this.assuntos = assuntos;
    }
     ...
     * @return interessados
     */
    public br.gov.cultura.DitelAdm.wsdl.Interessado[] getInteressados() {
        return interessados;
    }
     ...
     * @param interessados
     */
    public void setInteressados(br.gov.cultura.DitelAdm.wsdl.Interessado[] interessados) {
        this.interessados = interessados;
    }
     ...
     * @return observacoes
     */
    public br.gov.cultura.DitelAdm.wsdl.Observacao[] getObservacoes() {
        return observacoes;
    }
     ...
     * @param observacoes
     */
    public void setObservacoes(br.gov.cultura.DitelAdm.wsdl.Observacao[] observacoes) {
        this.observacoes = observacoes;
    }
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.ProcedimentoResumido[] getProcedimentosRelacionados() {
        return procedimentosRelacionados;
    }
     ...
     */
    public void setProcedimentosRelacionados(br.gov.cultura.DitelAdm.wsdl.ProcedimentoResumido[] procedimentosRelacionados) {
        this.procedimentosRelacionados = procedimentosRelacionados;
    }
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.ProcedimentoResumido[] getProcedimentosAnexados() {
        return procedimentosAnexados;
    }
     ...
     */
    public void setProcedimentosAnexados(br.gov.cultura.DitelAdm.wsdl.ProcedimentoResumido[] procedimentosAnexados) {
        this.procedimentosAnexados = procedimentosAnexados;
    }
