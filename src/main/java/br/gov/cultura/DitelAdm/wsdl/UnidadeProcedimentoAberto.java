...
public class UnidadeProcedimentoAberto  implements java.io.Serializable {
    ...
    private br.gov.cultura.DitelAdm.wsdl.Usuario usuarioAtribuicao;
    ...
    public UnidadeProcedimentoAberto(
           ...
           br.gov.cultura.DitelAdm.wsdl.Usuario usuarioAtribuicao) {
     ...
     */
    public br.gov.cultura.DitelAdm.wsdl.Usuario getUsuarioAtribuicao() {
        return usuarioAtribuicao;
    }
     ...
     */
    public void setUsuarioAtribuicao(br.gov.cultura.DitelAdm.wsdl.Usuario usuarioAtribuicao) {
        this.usuarioAtribuicao = usuarioAtribuicao;
    }
