...
public class Andamento  implements java.io.Serializable {
    ...
    private br.gov.cultura.DitelAdm.wsdl.AtributoAndamento[] atributos;
    ...
    public Andamento(
           ...
           br.gov.cultura.DitelAdm.wsdl.AtributoAndamento[] atributos) {
     ...
     * @return atributos
     */
    public br.gov.cultura.DitelAdm.wsdl.AtributoAndamento[] getAtributos() {
        return atributos;
    }
     ...
     * @param atributos
     */
    public void setAtributos(br.gov.cultura.DitelAdm.wsdl.AtributoAndamento[] atributos) {
        this.atributos = atributos;
    }
