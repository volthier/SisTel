...
public class AndamentoMarcador  implements java.io.Serializable {
    ...
    private br.gov.cultura.DitelAdm.wsdl.Marcador marcador;
    ...
    public AndamentoMarcador(
           ...
           br.gov.cultura.DitelAdm.wsdl.Marcador marcador) {
     ...
     * @return marcador
     */
    public br.gov.cultura.DitelAdm.wsdl.Marcador getMarcador() {
        return marcador;
    }
     ...
     * @param marcador
     */
    public void setMarcador(br.gov.cultura.DitelAdm.wsdl.Marcador marcador) {
        this.marcador = marcador;
    }
